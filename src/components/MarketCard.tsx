...
const MarketCard = ({ market, compact = false }: MarketCardProps) => {
  ...
  return (
    <button
      ...
      className="w-full text-left bg-card rounded-lg border border-border p-4 hover:border-primary/30 transition-all animate-slide-up"
    >
      {/* Category + time */}
      ...
      {/* Title */}
      <h3 className="font-display font-semibold text-sm leading-snug mb-3 text-foreground">
        {market.title}
      </h3>

      {/* Price bars */}
      <div className="flex gap-2 mb-3">
        <div className="flex-1 bg-success/10 rounded-md px-3 py-2 text-center">
        ...
        <div className="flex-1 bg-destructive/10 rounded-md px-3 py-2 text-center">
