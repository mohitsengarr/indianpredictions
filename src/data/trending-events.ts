...
export const TRENDING_EVENTS: TrendingEvent[] = [
  ...
  },
  {
    ...
    title: 'High Oil Prices Risk – Current Account & Growth Hit',
    category: 'energy',
    status: 'critical',
    summary:
      'With the Iran conflict pushing oil higher, economists warn India’s external balance, inflation, and growth outlook could deteriorate sharply if crude stays near $100+ for long.',
    imageUrl: 'https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=800',
    keyDrivers: [
      'Iran conflict risk premium in crude prices and shipping routes',
      'India’s high oil import dependence increases pass-through to CAD, inflation, and fiscal subsidy needs',
      'Rupee pressure and FII risk-off feedback loop when energy shock persists',
    ],
    keyDataPoints: [
      { label: 'CAD if oil ~$100', value: '1.9%–2.0% of GDP (FY26/27)' },
      { label: 'CAD baseline', value: '0.5%–0.8% of GDP (projected FY26/27)' },
      { label: 'GDP growth if oil ~$100', value: '6.6% (vs >7% base)' },
      { label: 'GDP growth if oil ~$130', value: '6.0%' },
      { label: 'Inflation if oil ~$100', value: '4.1% (vs 2.75% in Jan)' },
    ],
    mckinseyAnalysis: [
      'This is a classic “terms-of-trade shock”: higher oil import bill widens CAD, pressures the rupee, and can force tighter financial conditions.',
      'Fiscal risk is two-layered: higher explicit subsidies (fertiliser, LPG, OMCs) plus implicit growth drag that lowers tax buoyancy.',
      'Scenario planning: (1) short shock (2–4 weeks) → markets stabilise; (2) sustained shock (quarter+) → growth downgrade + INR weakness; (3) escalation → rationing/subsidy spike and broader risk-off in EMs.',
    ],
    impactProbability: 'High if oil stays near $100+ for multiple weeks; severe if sustained into Q2',
    predictionMarketAngle: 'Will India’s current account deficit exceed 1.5% of GDP in FY26/27?',
    categoryLabel: 'Energy',
    categoryEmoji: '⛽',
    updatedAt: '2026-03-13T00:00:00Z',
  },
