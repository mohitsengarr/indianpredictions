...
export const TRENDING_EVENTS: TrendingEvent[] = [
  ...
  },
  {
    ...
    keyDetails: [
      ...
      'Bengaluru clearance pending from Karnataka govt expert committee',
      'Remaining 54 matches to be announced post election schedule confirmation',
    ],
    mckinseyAnalysis: [
      'Split-phase scheduling is a BCCI first – driven by election calendar uncertainty',
      'Franchise revenue models (ticketing, local sponsorships) disrupted by uncertain phase-2 schedule',
      'LPG shortage could affect stadium food courts; potential fan experience impact',
      'Bengaluru clearance requirement adds regulatory risk to marquee matches',
    ],
    predictionMarketAngle: 'Will all 10 IPL teams play at home venues in Phase 1?',
    categoryLabel: 'Sports',
    categoryEmoji: '🏏',
    updatedAt: '2026-03-13T00:00:00Z',
  },
  {
    id: 'evt-30',
    slug: 'india-pakistan-tensions-march-2026',
    title: 'India-Pakistan Tensions Rise Over LoC Ceasefire Violations',
    category: 'geopolitics',
    status: 'active',
    summary:
      'Cross-border tensions along Line of Control (LoC) have increased with multiple ceasefire violations reported in March 2026. India and Pakistan exchange diplomatic notes.',
    mckinseyAnalysis: [
      'Border tensions historically create short-term market volatility in India',
      'Defense stocks typically benefit from escalating security concerns',
      'Pakistan’s economic fragility limits scope for major escalation',
    ],
    predictionMarketAngle: 'Will India-Pakistan tensions lead to cross-border military engagement by May 2026?',
    categoryLabel: 'Geopolitics',
    categoryEmoji: '🚨',
    updatedAt: '2026-03-13T00:00:00Z',
  },
